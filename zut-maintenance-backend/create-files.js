...
['db', 'routes', 'middleware', 'uploads'].forEach(dir => {
...
// Create db/index.js
const dbIndexContent = `const { Pool } = require('pg');
...
fs.writeFileSync(path.join(baseDir, 'db/index.js'), dbIndexContent);
...
fs.writeFileSync(path.join(baseDir, 'middleware/auth.js'), authMiddlewareContent);
...
fs.writeFileSync(path.join(baseDir, 'routes/auth.js'), authRoutesContent);
...
fs.writeFileSync(path.join(baseDir, 'routes/reports.js'), reportsRoutesContent);

console.log('All files created successfully!');`;

fs.writeFileSync(path.join('C:\\Users\\Joseph\\Desktop\\Stan\'s Project\\zut-maintenance-backend', 'create-files.js'), content);
